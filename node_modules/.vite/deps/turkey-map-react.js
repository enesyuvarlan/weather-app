  ...
  "node_modules/turkey-map-react/lib/index.js"(exports, module) {
    (() => {
      ...
      var C = { 418: (C2) => {
        ...
        function n(C3) {
          if (null == C3) throw new TypeError("Object.assign cannot be called with null or undefined");
          return Object(C3);
        }
        C2.exports = function() {
          try {
            ...
            if (C3[5] = "de", "5" === Object.getOwnPropertyNames(C3)[0]) return false;
            for (var e3 = {}, t3 = 0; t3 < 10; t3++) e3["_" + String.fromCharCode(t3)] = t3;
          ...
          for (var o, i, u = n(C3), l = 1; l < arguments.length; l++) {
            for (var p in o = Object(arguments[l])) t2.call(o, p) && (u[p] = o[p]);
            if (e2) {
              i = e2(o);
              for (var c = 0; c < i.length; c++) r2.call(o, i[c]) && (u[i[c]] = o[i[c]]);
            }
          }
          return u;
        };
        ...
        function b(C3) {
          for (var e3 = "https://reactjs.org/docs/error-decoder.html?invariant=" + C3, t3 = 1; t3 < arguments.length; t3++) e3 += "&args[]=" + encodeURIComponent(arguments[t3]);
        ...
        v.prototype.isReactComponent = {}, v.prototype.setState = function(C3, e3) {
          if ("object" != typeof C3 && "function" != typeof C3 && null != C3) throw Error(b(85));
        ...
        function w(C3, e3, t3) {
          ...
          if (null != e3) for (r3 in void 0 !== e3.ref && (i2 = e3.ref), void 0 !== e3.key && (o2 = "" + e3.key), e3) N.call(e3, r3) && !O.hasOwnProperty(r3) && (n2[r3] = e3[r3]);
          var u2 = arguments.length - 2;
          if (1 === u2) n2.children = t3;
          else if (1 < u2) {
            for (var l2 = Array(u2), p2 = 0; p2 < u2; p2++) l2[p2] = arguments[p2 + 2];
            n2.children = l2;
          }
          if (C3 && C3.defaultProps) for (r3 in u2 = C3.defaultProps) void 0 === n2[r3] && (n2[r3] = u2[r3]);
        ...
        function x(C3, e3, t3, r3) {
          ...
          if (i2) return t3(r3, C3, "" === e3 ? "." + A(C3, 0) : e3), 1;
          if (i2 = 0, e3 = "" === e3 ? "." : e3 + ":", Array.isArray(C3)) for (var u2 = 0; u2 < C3.length; u2++) {
            var l2 = e3 + A(n2 = C3[u2], u2);
            i2 += x(n2, l2, t3, r3);
          }
          else if ("function" == typeof (l2 = null === C3 || "object" != typeof C3 ? null : "function" == typeof (l2 = y && C3[y] || C3["@@iterator"]) ? l2 : null)) for (C3 = l2.call(C3), u2 = 0; !(n2 = C3.next()).done; ) i2 += x(n2 = n2.value, l2 = e3 + A(n2, u2++), t3, r3);
          else if ("object" === n2) throw t3 = "" + C3, Error(b(31, "[object Object]" === t3 ? "object with keys {" + Object.keys(C3).join(", ") + "}" : t3, ""));
          return i2;
        }
        function R(C3, e3, t3) {
        ...
        e2.Children = { map: function(C3, e3, t3) {
          ...
          if (null == C3) throw Error(b(267, C3));
          var n2 = r2({}, C3.props), o2 = C3.key, i2 = C3.ref, u2 = C3._owner;
          if (null != e3) {
            if (void 0 !== e3.ref && (i2 = e3.ref, u2 = g.current), void 0 !== e3.key && (o2 = "" + e3.key), C3.type && C3.type.defaultProps) var l2 = C3.type.defaultProps;
            for (p2 in e3) N.call(e3, p2) && !O.hasOwnProperty(p2) && (n2[p2] = void 0 === e3[p2] && void 0 !== l2 ? l2[p2] : e3[p2]);
          }
          var p2 = arguments.length - 2;
          if (1 === p2) n2.children = t3;
          else if (1 < p2) {
            l2 = Array(p2);
            for (var c2 = 0; c2 < p2; c2++) l2[c2] = arguments[c2 + 2];
            n2.children = l2;
          }
      ...
      t.d = (C2, e2) => {
        for (var r2 in e2) t.o(e2, r2) && !t.o(C2, r2) && Object.defineProperty(C2, r2, { enumerable: true, get: e2[r2] });
      ...
      (() => {
        ...
        function s(C3, e3) {
          if (e3 && ("object" === u(e3) || "function" == typeof e3)) return e3;
          if (void 0 !== e3) throw new TypeError("Derived constructors may only return object or undefined");
          return m(C3);
        }
        function m(C3) {
          if (void 0 === C3) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
          return C3;
        }
        function d(C3) {
        ...
        var b = function(e3) {
          ...
          var t2, r2, n2, a2, o2 = (n2 = u2, a2 = function() {
            ...
            } else C3 = e4.apply(this, arguments);
            return s(this, C3);
          });
          function u2(e4) {
            var t3;
            return function(C3, e5) {
              if (!(C3 instanceof e5)) throw new TypeError("Cannot call a class as a function");
              ...
              if ("path" === t4.tagName) {
                ...
                if (e5 && "function" == typeof e5) return void e5({ id: n3, name: u3, plateNumber: i2, path: a3 });
              }
